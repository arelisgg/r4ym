...
class Mls_Process extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( ' Working Process', 'themex' );
    }
    ...
    protected function register_controls() {
			...
			$this->start_controls_section(
				...
				[
					'label' => esc_html__( 'Working Process Options', 'themex' ),
					...
					$this->add_control(
						...
						[
							...
							'default' => esc_html__( 'Deep Expertise & Leadership', 'themex' ),
							'separator'=>'before',
							'placeholder' => esc_attr__( 'Type your process title here', 'themex' ),						
						]
					);
					/* title_link */	
					$this->add_control(
				...
				/* witr_process_content	*/
					$this->add_control(
						...
						[
							...
							'default' => esc_html__( 'We help businesses elevate their through custom service software development product design.', 'themex' ),
							'separator'=>'before',
		...
		$this->start_controls_section(
			...
			[
				...
				$this->add_responsive_control(
					'witr_box2',
					[
						'label' => esc_html__( ' Box 2 Option', 'themex' ),
    ...
    protected function render( $instance = [] ) {
		...
		$txbd_image = ! empty($witrshowdata['witr_process_image']['url']) ?  Group_Control_Image_Size::get_attachment_image_html( $witrshowdata, 'txbd_image_size', 'witr_process_image' ) : '';		
