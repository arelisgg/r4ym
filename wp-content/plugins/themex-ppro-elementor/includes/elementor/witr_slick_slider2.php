...
class Mls_Slick_slider2 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Slick Slider2', 'themex' );
    }
    ...
    protected function register_controls() {
			...
			/*   witr_style_slick */
				...
				$repeater->add_control(
					'witr_vshow_buttoni',
					[
						'label' => esc_html__( 'Show Left Right Video', 'themex' ),
						'type' => Controls_Manager::SWITCHER,
						'label_on' => esc_html__( 'Show', 'themex' ),
						'label_off' => esc_html__( 'Hide', 'themex' ),
						'return_value' => 'yes',
    ...
    protected function render( $instance = [] ) {
		...
		$txbd_image = ! empty($witrshowdata['witrani_bg_image']['url']) ?  Group_Control_Image_Size::get_attachment_image_html( $witrshowdata, 'txbd_image_size', 'witrani_bg_image' ) : '';		
