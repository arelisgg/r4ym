...
class Mls_Case extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Case Study', 'themex' );
    }
    ...
    protected function register_controls() {
			...
			$this->start_controls_section(
				...
				[
					'label' => esc_html__( ' Case Study Options', 'themex' ),
				...
				$this->add_control(
					'witr_style_case',
					[
						'label' => esc_html__( 'Case style', 'themex' ),
					...
					$this->add_control(
						...
						[
							...
							'separator'=>'before',
							'placeholder' => esc_attr__( 'Type your case title here', 'themex' ),						
						]
					);
    ...
    protected function render( $instance = [] ) {
		...
		$txbd_image='';	
		if( !empty( $witrshowdata['witr_case_image']['url'] ) ){
			$txbd_image = Group_Control_Image_Size::get_attachment_image_html( $witrshowdata, 'txbd_image_size', 'witr_case_image' );
		}		
	...
	switch ( $witrshowdata['witr_style_case'] ) {
		...
		<div class="witr_case all_case_color witr_case2">
			<?php if( !empty( $witrshowdata['witr_case_image']['url'] ) ){?>
